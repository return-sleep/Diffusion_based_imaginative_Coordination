...
<table>
  <tr>
    <td><img src="./assets/task_vis_all.png" alt="Image 1" width="300"/></td>
    <td><img src="./assets/results_vis.png" alt="Image 2" width="330"/></td>
  </tr>
</table>
...
``` 
cd policy/ACT-DP-TP
bash scripts/train.sh block_hammer_beat 0 0 0
